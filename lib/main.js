(function() {
  'use strict';
  var D3F, Effstring_error, Effstring_lib_syntax_error, Effstring_syntax_error, Effstring_syntax_fillwidth_error, Effstring_validation_error, _default_locale, _escape_regex, _fmtspec_re, _hint_as_locale_cfg, _locale_cfg_from_bcp47, _locale_cfg_from_hints, _to_width, debug, f, log, new_ftag, rpr, types, width_of,
  ...
  Effstring_syntax_error = class Effstring_syntax_error extends Effstring_error {
    constructor(ref, part, message = null) {
  ...
  _to_width = function(text, fmt_cfg) {
    var fill_re, matcher, p, shorter_text/* TAINT use unicode flag? */;
